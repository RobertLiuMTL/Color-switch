...
public abstract class Level {
    ...
    public void tick(double dt) {
        for (Obstacle o : obstacles) {
            ...
            if (o instanceof GrowingCircle) {
                ((GrowingCircle) o).grossir();
            }

            if (o instanceof VerticalBar) {
                ((VerticalBar) o).bouger(this.screenWidth);

            }
            if (o instanceof RotatingCircle) {
            	((RotatingCircle) o).rotate();
            }
            else {
